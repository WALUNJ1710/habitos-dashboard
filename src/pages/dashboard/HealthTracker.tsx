...
import { Scale, Ruler, Target, TrendingDown, Activity, Loader2 } from "lucide-react";
...
const HealthTracker = () => {
  ...
  const [goalWeight, setGoalWeight] = useState(profile?.goal_weight?.toString() || "0");
  ...
  const handleSave = async () => {
    ...
    if (error) {
      ...
      toast({ title: "Saved!", description: "Your measurements have been updated." });
    }
  };
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={weightHistory}>
                ...
                <ReferenceLine
                  ...
                  strokeDasharray="5 5"
                  label={{ value: "Goal", fill: "hsl(var(--success))", fontSize: 12 }}
                />
                <Line
                  type="monotone"
                  dataKey="weight"
