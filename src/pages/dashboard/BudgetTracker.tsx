...
import { CalendarIcon, Wallet, TrendingUp, TrendingDown, Plus, CreditCard, Smartphone, Banknote, Building, Trash2 } from "lucide-react";
import {
  PieChart,
  Pie,
  Cell,
...
const BudgetTracker = () => {
  ...
  const totalBudget = profile?.budget_goal || 0;
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <div className="space-y-3 max-h-64 overflow-y-auto">
          {expenses.length === 0 ? (
            <p className="text-center text-muted-foreground py-8">No transactions yet. Add your first expense above!</p>
          ) : (
